        ...
        <div>
            ...
            <div className="h-screen w-full flex flex-row justify-center">
                <div className="w-full p-4 m-10">
                    <h1 className=" text-6xl p-10">Contact Us</h1>
                ...
                <div className=" w-full px-10">
                    <div className=" rounded-xl mr-[100px] mt-[10px] pl-[10px] pr-[30px] py-2 bg-gray-100 h-[600px] shadow-2xl">
                    <h1 className=" text-xl font-bold px-5 pt-5" >Send us your query !</h1>
                        <form className="flex flex-col">
                            ...
                            <input type="text" placeholder="How can we help you ?" className=" text-top bg-blue-grey-100 mx-4 my-3 p-2 h-[150px] rounded-2xl" id="query"></input>
